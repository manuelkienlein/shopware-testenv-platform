...
- Storefront and administration actions in the Explore view remain disabled until sandbox health checks report the container as ready
- Fix shopware admin login in Dockware Prod images by clearing cache after ENV_Mode change
